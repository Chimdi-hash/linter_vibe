...
const LINTERVIBE_CONTRACT_ADDRESS = "0x9b0A2D6dCEB32FCC5ba8921289146A8D587CD6C1";
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function performAnalysis() {
        ...
        try {
            ...
            // We increase the polling duration to 5 minutes (60 retries * 5s interval) because LLM consensus 
            // can sometimes take longer, especially if multiple transactions are submitted in close succession.
